...
- 🧠 **lina-mlops** – Pipeline MLOps pour déployer et suivre des modèles de ML  
- 🌐 **Mon-API-BLOG** – API blog construite avec JavaScript / Node  
- 🧪 **MERN / MERN1** – Applications full-stack avec la stack **MERN**  
- 🎯 **Job-Quiz-Generator** – Génération de quiz pour l’orientation/profils jobs  
